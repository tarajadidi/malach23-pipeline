...
from models.baseline.HiFiGanWrapper import HiFiGanWrapper
...
class DCASE2023FoleySoundSynthesis:
    def __init__(
        ...
        self.sr: int = 22050
        self.save_dir: str = "models/baseline/synthesized"
...
class BaseLineModel(SoundSynthesisModel):
    def __init__(
        ...
        self.hifi_gan = HiFiGanWrapper(
            'models/baseline/checkpoint/hifigan/g_00935000',
            'models/baseline/checkpoint/hifigan/hifigan_config.json',
        )
